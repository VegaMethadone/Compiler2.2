...
gcc -o "${OUT_DIR}/parser" "${BUILD_DIR}/error.o" "${BUILD_DIR}/lex.yy.o" "${BUILD_DIR}/main.o" "${BUILD_DIR}/node.o" "${BUILD_DIR}/parser.tab.o" "${BUILD_DIR}/streamGraph.o" "${BUILD_DIR}/slice.o"
